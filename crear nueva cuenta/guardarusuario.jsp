...
<%
    ...
    try {
        ...
        String query = "INSERT INTO usuarios (nombre_usuarios, apellido_usuarios, correo_elec_usuarios, contraseña_usuarios, dirrec_usuarios, telefono_usuarios, descripcion_usuarios, contraseña_confirmacion) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
